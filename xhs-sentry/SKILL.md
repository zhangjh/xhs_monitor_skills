---
name: xhs-sentry
description: 小红书通用舆情监控技能。按关键词巡检小红书搜索结果，输出页面状态、结构化笔记摘要、爆火/负面/竞品信号和现场截图。适用于品牌舆情监控、竞品动态分析、口碑巡检、热点追踪。当用户要求“监控小红书舆情”“查某个词在小红书怎么讨论”“看看有没有负面/爆火内容”“做竞品对比巡检”时使用。
---

# 小红书舆情哨兵

执行关键词级小红书巡检，输出**现场证据 + 初步舆情判断**。
